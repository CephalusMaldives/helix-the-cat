...
$(document).ready(function() {
    var masterTableId = 'statement';
    var halihax = new HalihaxPrint('.' + masterTableId + ' tbody', 10);
...
class HalihaxPrint {
    constructor(tableBodySelector, interval) {
        ...
        this.tableProcessor = new TableProcessor($(this.tableBodySelector).find('tr'));
...
class TableProcessor {
    constructor(tableRows) {
        ...
        this.GetUnwantedRows = function () {
            var that = this;
            var unwanted = $(this.tableRows).filter(function (idx, el) {
        ...
        this.GetUnprocessedUnwantedRows = function () {
            ...
            return $(that.tableRows).filter(function (idx, el) {
                var description = el.getColumnValue('description').toString();
    ...
    UpdateOutflowValues(distributedValues) {
        ...
        return el.getColumnValue('description').includesAny(that.replacementRecipients)
